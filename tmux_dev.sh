...
tmux -S /tmp/cluster_dev new-window -t cluster_dev -n file \; send-keys "vi file.cpp" Enter \; split-window -h \; select-layout main-vertical \; send-keys -t 1 "vi file.h" Enter
